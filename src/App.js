...
const App = () => {
  ...
  const handleBurnClick = () => {
    if (!burnTrigger) { // Prevent setting the trigger if it's already set.
      setBurnTrigger(true);
    }
  };
  ...
  <div className="text-gray-500 dark:text-gray-400">
    {userPublicKey ? `${userPublicKey.substring(0, 5)}...` : "Not connected"}
  </div>
              ...
              <div className="grid gap-4 md:grid-cols-1">
                <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                  <div className="grid gap-1">
                    <Label className="text-sm" htmlFor="tokens">Tokens to burn</Label>
                    <input
        type="number"
        value={amountToBurn}
...
/>                  </div>
              ...
              <UserPixelsBox userPublicKey={userPublicKey}></UserPixelsBox>
